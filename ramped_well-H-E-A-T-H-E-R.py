...
def main():
    # for i, interval in enumerate([(1.472, 1.486), (2.286, 2.307), (4.148, 4.159)]):
    #     E, E_l, E_u = bisection(generatePsiEndpoint, *interval)
    #     print(f'Energy Eigenvalue E{i+2} = {E}')
    ...
    # visualRootFinding(np.linspace(4.12, 4.17, 30))
